...
A Spring Boot REST API that provides CRUD operations for emails pertaining to Animals and Nature.  AWS SNS and AWS Lambda were used to receive email messages and send the messages to the API.  Authorization was built in using OAuth 2.0.  This API is currently hosted on Render.  NOTE:  I am currently using the free plan so startup could take several minutes.
